...
for quiz_num in range(35):
    ...
    quiz_file = open(f'capitalsquiz_{quiz_num + 1}.txt', 'w')
    answer_key_file = open(f'capitalsquiz_answers_{quiz_num + 1}.txt', 'w')

    # write out the header for the quix
    ...
    for quest_num in range(50):
        ...
        answer_key_file.write(f"{quest_num + 1}. {'ABCD'[answer_options.index(correct_answer)]}\n")
    quiz_file.close()
